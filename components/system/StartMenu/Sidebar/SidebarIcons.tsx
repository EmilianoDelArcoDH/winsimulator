...
export const Help = memo(() => (
  <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    <path d="M16 0C7.164 0 0 7.164 0 16s7.164 16 16 16 16-7.164 16-16S24.836 0 16 0zm0 30C8.268 30 2 23.732 2 16S8.268 2 16 2s14 6.268 14 14-6.268 14-14 14zm0-7a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm.188-17c3.492 0 6.312 2.344 6.312 5.625 0 2.438-1.43 3.828-3.047 4.875-1.469.953-2.453 1.672-2.453 3.5h-2c0-2.953 1.672-4.078 3.36-5.172 1.234-.797 2.14-1.61 2.14-3.203C20.5 9.484 18.625 8 16.188 8c-2.344 0-4.172 1.328-4.688 3.656l-1.953-.437C10.25 8.047 12.813 6 16.187 6z" />
  </svg>
));
